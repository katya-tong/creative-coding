...
void drawCylinder() {
  ...
  for (int j = 0; j < cylinderHeightSection; j ++) {
    for (int i = 0; i < sectionSideNum; i ++) {
      float x11 = sectionR[j] * (1-cos(theta * i + sectionTwistPhase[j])) * cos(theta * i + sectionTwistPhase[j]);
      float y11 = sectionR[j] * (1-cos(theta * i + sectionTwistPhase[j])) * sin(theta * i + sectionTwistPhase[j]);
      float x12 = sectionR[j] * (1-cos(theta * ((i+1)%sectionSideNum) + sectionTwistPhase[j])) * cos(theta * ((i+1)%sectionSideNum) + sectionTwistPhase[j]);
      float y12 = sectionR[j] * (1-cos(theta * ((i+1)%sectionSideNum) + sectionTwistPhase[j])) * sin(theta * ((i+1)%sectionSideNum) + sectionTwistPhase[j]);

      float x21 = sectionR[j+1] * (1-cos(theta * i + sectionTwistPhase[j+1])) * cos(theta * i + sectionTwistPhase[j+1]);
      float y21 = sectionR[j+1] * (1-cos(theta * i + sectionTwistPhase[j+1])) * sin(theta * i + sectionTwistPhase[j+1]);
      float x22 = sectionR[j+1] * (1-cos(theta * ((i+1)%sectionSideNum) + sectionTwistPhase[j+1])) * cos(theta * ((i+1)%sectionSideNum) + sectionTwistPhase[j+1]);
      float y22 = sectionR[j+1] * (1-cos(theta * ((i+1)%sectionSideNum) + sectionTwistPhase[j+1])) * sin(theta * ((i+1)%sectionSideNum) + sectionTwistPhase[j+1]);

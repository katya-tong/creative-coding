...
void UI() {
  ...
  bar.addSlider("sectionSideNum", 3, 40, 10, canvasLeftCornerX, canvasLeftCornerY, barSize, barHeight).setLabel("断面边数");
  ...
  bar.addSlider("colorRed", 0, 255, 127, canvasLeftCornerX, canvasLeftCornerY+barInterval*7, barSize, barHeight).setLabel("红色强度");
  bar.addSlider("colorGreen", 0, 255,127, canvasLeftCornerX, canvasLeftCornerY+barInterval*8, barSize, barHeight).setLabel("绿色强度");
  bar.addSlider("colorBlue", 0, 255, 127, canvasLeftCornerX, canvasLeftCornerY+barInterval*9, barSize, barHeight).setLabel("蓝色强度");
